<template>
  ...
  <div class="wrapper">
    <div style="margin: 170px auto; background-color: #fff; width: 350px; height: 300px; padding: 20px; border-radius: 20px">
      ...
      <el-form :model="user" :rules="rules" ref="userForm">
        ...
        <el-form-item style="margin: 10px 0; text-align: right">
          ...
          <el-button type="success" plain size="small"  autocomplete="off" @click="$router.push('/register')">注册</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
